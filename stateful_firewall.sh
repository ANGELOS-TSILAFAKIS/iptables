...
#THIS IS A GOOD AND SECURE FIREWALL FOR A DESKTOP OPERATING SYSTEM
...
#drop invalid packets on INPUT and on OUTPUT CHAINS
...
#set policy to DROP on INPUT and on OUTPUT
