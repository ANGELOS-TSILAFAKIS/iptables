...
#this scrips permits routed traffic (this is the Router) only for soma MAC addresses

#flush the filter table / FORWARD CHAIN
iptables -F FORWARD

#variable with pemited MAC addresses
PERMITED_MACS="08:00:27:c8:75:38 08:00:27:c8:75:ab"


#itarate through the list with allowed MAC addresses
